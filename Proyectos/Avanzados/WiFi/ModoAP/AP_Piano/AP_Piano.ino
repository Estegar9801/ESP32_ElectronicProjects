/* 
  ...
  Descripción: Estableciendo el ESP32 como punto de acceso, se disponibiliza
  una interfaz la cuál estará disponible para los usuarios que se conecten al
  dispositivo con las credenciales correctas. Dentro de esta interfaz, podrán
  interactuar con un piano electrónico, el cuál permitirá el control del buzzer
